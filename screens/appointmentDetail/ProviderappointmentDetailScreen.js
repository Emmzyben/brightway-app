...
const ProviderAppointmentDetailScreen = ({ navigation }) => {
    return (
    ...
    function appintmentDetail() {
        return (
            <View style={{ backgroundColor: Colors.whiteColor, padding: Sizes.fixPadding * 2.0, }}>
                ...
                {divider()}
                {appointmentDetailShort({ title: 'Description', value: 'I am having headache', icon: 'person-outline' })}
            </View>
        )
    }
    ...
    function patientInfo() {
        return (
            <TouchableOpacity
                ...
                style={styles.patientInfoWrapStyle}
            >
                <View style={{ ...styles.doctorImageBackgroundStyle, }}>
                    <Image
                        source={require('../../assets/images/patients/patient5.png')}
