...
const userMessages = [
  ...
  {
    id: "2",
    message: "Hello, ma’m\nI’ll reach by 10min at your plase.",
    isSender: false,
    messageDateAndTime: "Jan 23, 10:05 pm",
  },
];

const ChatWithCustomerScreen = ({ navigation }) => {
  const [messagesList, setMessagesList] = useState(userMessages);
  const customerImage = require("../../assets/images/users/user2.png");
    ...
    return (
      <View style={styles.headerStyle}>
        <View style={{ flex: 1, flexDirection: "row", alignItems: "center" }}>
          ...
          />
          <Image source={customerImage} style={styles.headerImageStyle} />
